...
Full write-up with charts and reasoning: see `HR_Attrition_Results_Writeup.pdf` in this repo. A one-page summary version — good for attaching to a resume or sharing in an interview — is in `HR_Attrition_OnePager.pdf`.
...
- `HR_Attrition_Results_Writeup.pdf` — full write-up: every chart, captioned and explained
- `HR_Attrition_OnePager.pdf` — one-page summary of findings and recommendations
- `README.md` — this file
